...
namespace RemoteDeploy.TFTP
{
    public static class FTPHelper
    {
        ...
        /// 远程路径存储变量
        /// </summary>
        public static string ftpRemotePath = string.Empty;
        ...
        /// <param name="updateProgress">报告进度的处理(第一个参数：总大小，第二个参数：当前进度)</param>
        /// <returns></returns>       
        public static bool FtpUploadBroken(string ftpServerIP, string localFullPath, string remoteFilepath, Action<int, int> updateProgress = null)
        {
